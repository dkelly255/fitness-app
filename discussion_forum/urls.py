...
urlpatterns = [
    ...
    path(
        'delete_comment/<topic_id>/<comment_id>',
        views.delete_comment, name='delete_comment'),
    path(
        'edit_comment/<topic_id>/<comment_id>',
        views.edit_comment, name='edit_comment'),
    path(
        'reply_to_comment/<topic_id>/<comment_id>',
        views.reply_to_comment, name='reply_to_comment'),
    path(
        'delete_reply/<topic_id>/<reply_id>',
        views.delete_reply, name='delete_reply'),
    path(
        'edit_reply/<topic_id>/<reply_id>',
        views.edit_reply, name='edit_reply'),
    path(
        'user_activity/<str:author>',
